...
def fetch_length_featuers(q1,q2):
...
def fetch_fuzzy_featuers(q1,q2):
...
def query_point(q1,q2):
    ...
    token_featuer = fetch_token_features(q1,q2)

    input_query.extend(token_featuer)

    length_features = fetch_length_featuers(q1,q2)
    input_query.extend(length_features)

    fuzzy_featuer = fetch_fuzzy_featuers(q1,q2)
    input_query.extend(fuzzy_featuer)
